...
export default function FragnenceChoice() {
  ...
  const handleEnquireScroll = (e: React.MouseEvent<HTMLAnchorElement>) => {
    ...
    if (contactSection) {
      ...
      const event = new CustomEvent("select-enquiry-type", {
        detail: {
          type: "recommendation",
          message: `Hi Fragnence! I took the Scent Quiz and matched with ${result?.title} (${result?.family}). I would love to try this fragrance!`
        }
      });
  ...
  const whatsappMessage = result
    ? `Hi Fragnence! I completed your Scent Quiz and got matched with "${result.title}" (${result.family}). I would love to know if you have this in stock or could recommend a perfume in this family! Thank you.`
    : "Hi Fragnence! I would like to get a personalized fragrance consultation.";
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-3xl md:text-5xl font-serif font-light tracking-wide text-gold-100 mb-6">
            Fragnence <span className="font-normal italic text-gold-400">Choice</span>
          </p>
          ...
          <AnimatePresence mode="wait">
            {!result ? (
              ...
              >
                ...
                <p className="text-xs font-bold tracking-[0.25em] text-gold-500 uppercase mb-2">
                ...
                <div className="mb-8">
                  <p className="text-xs font-semibold text-charcoal-400 tracking-widest uppercase mb-4">
                    Key Matching Notes
                  </p>
